package com.intellie.user.core.aspect;
...
public class UserPermission {
    ...
    private Logger logger = LoggerFactory.getLogger(UserPermission.class);

    @Value("${user.isGateway}")
    private int isGateway;//是否开启网关的身份识别

    @Pointcut("execution(* com.intellie.user.export..*.*(..))")
